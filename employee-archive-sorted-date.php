                ...
                <div class="row">
                    <div class="container-fluid">
                        <div class='form-inline float-left ml-1' id="sort-pick">
                            <select class="form-control sort-data" id="sort-data" onchange="location = this.value;" name="sort-data">
                                <option value="./employee-archive.php">Sort by name</option>
                    ...
                    <table class="table table-hover table-striped text-center">
                        ...
                        <tbody class="tbody">
                            ...
                            try {
                                $fetchData = $database->getReference('archive_employee')->orderByChild('date_deleted')->startAt('2022-02-01')->getValue();
                            } catch (Exception $e) {
                                echo $e->getMessage();
                            }
