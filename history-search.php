                ...
                <div class="row">
                    ...
                    <table class="table table-hover table-striped text-center">
                        ...
                        <tbody>
                            ...
                            include 'dbcon.php';
                            try {
                                $fetchData = $database->getReference('success_appointment')->orderByChild($search_query)->equalTo($search_val)->getValue();
                            } catch (Exception $e) {
                                echo $e->getMessage();
                            }
