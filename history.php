...
if (isset($_POST['search-btn'])) {
    ...
    header("Location: ./history-search.php");
}
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="row">
                    <div class="container-fluid">
                        ...
                        <div class='form-inline float-left ml-1' id="sort-pick">
                            <select class="form-control sort-data" id="sort-data" onchange="location = this.value;" name="sort-data">
                                ...
                                <option value="./history-sorted-serviced.php">Sort by serviced by</option>
                                <option value="./responsive.php">Print history</option>
                                <option value="./print-day.php">Print history today</option>
                                <option value="./print-one-week.php">Print history week</option>
                    ...
                    <table class="table table-hover table-striped text-center">
                        ...
                        <tbody>
                            ...
                            include 'dbcon.php';
                            try {
                                $fetchData = $database->getReference('success_appointment')->orderByChild('reserveBy_name')->getValue();
                            } catch (Exception $e) {
                                echo $e->getMessage();
                            }
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <form method="GET">
                                                <button type='button' data-id="<?php echo $key; ?>" name='delete-btn' class='btn btn-primary del-btn' data-toggle="modal" data-target="#confirmation"><i class='fa fa-trash fa-lg'></i></button>
                                            </form>
