                ...
                <div class="row">
                    <div class="container-fluid">
                        <div class='form-inline float-left ml-1' id="sort-pick">
                            <select class="form-control sort-data" id="sort-data" onchange="location = this.value;" name="sort-data">
                                <option value="./image-archive.php">Sort by name</option>

                                <option selected>Sort by date deleted</option>
                            </select>
                        </div>
                    ...
                    <table class="table table-hover table-striped text-center">
                        ...
                        <tbody>
                            ...
                            $fetchData = $database->getReference($ref_table)->orderByChild('date_deleted')->startAt('2022-02-01')->getValue();
                            if ($fetchData > 0) {
                ...
                <div class="text-center p-0">
                    <form method="GET">
                        <div class="row btn-row">
                            <input type="text" value="" id="imgs-name" name="imgs-name">
                            <input type="text" value="" id="imgs-date" name="imgs-date">
                            <input type="text" value="" id="imgs-downloadlink" name="imgs-downloadlink">
