...
<head>
    ...
    <title>TRENDZ: Manage Events</title>
</head>
    ...
    <div class="row main-wrapper">
        ...
        <div id="main" class="content-wrapper">
            ...
            <div class="col-md-12 mx-auto heading d-flex justify-content-md-left">
                <img src="./assets/manage_event.png" class="icon-heading">
                ...
                <div class="row">
                    <div class="container-fluid">
                        ...
                        <div class='form-inline float-left ml-1' id="sort-pick">
                            <select class="form-control sort-data" id="sort-data" onchange="location = this.value;" name="sort-data">
                                <option value="./manage-event.php">Sort by Title</option>
                    ...
                    <table class="table table-hover table-striped text-center">
                        ...
                        <tbody class="tbody">
                            ...
                            $fetchData = $database->getReference($ref_table)->orderByChild('announcement_fulldate')->startAt('2022-02-01')->getValue();
                            //$dt = '2017-Feb-10';
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td><?= $row['announcement_info']; ?></td>
                                        <td><?= $row['announcement_month']; ?> <?= $row['announcement_date']; ?>, <?= $row['announcement_year']; ?></td>
                                        <td>
                                            <div class="row">
                                                <form method="GET">
                                                    <button type='button' data-id="<?php echo $key; ?>" name='delete-btn' class='btn btn-primary ml-2 del-btn' data-toggle="modal" data-target="#confirmation"><i class='fa fa-archive fa-lg'></i></button>
                                                </form>
                                            </div>
